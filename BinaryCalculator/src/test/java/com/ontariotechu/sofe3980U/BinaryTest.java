...
public class BinaryTest 
{
    ...
    //Test all possible OR logic combination
    @Test
    public void or1() {
        Binary binary1=new Binary("0");
		Binary binary2=new Binary("0");
    ...
    //Tests all combinations of AND operation
    @Test
    public void and1() {
        Binary binary1=new Binary("0");
		Binary binary2=new Binary("0");
    ...
    public void multiply5() {
        Binary binary1=new Binary("1111011101");
		Binary binary2=new Binary("1110101");
        Binary binary3=Binary.multiply(binary1,binary2);
        assertTrue(binary3.getValue().equals("11100010000000001"));
    }
}
